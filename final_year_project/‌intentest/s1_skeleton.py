...
class PgdSkeleton(PgdLabel):
    ...
    def __getitem__(self, index):
            ...
            v_name = "video.mp4"
            coord_dict = self.__vpath_to_coords("video.mp4")
    ...
    def __predict_from_video(self, video_name):
        ...
        v_path = "C:/Users/srikr/Desktop/gestintpoi/gestintpoi/final_year_project/‌intentest/PoliceGestureLong/video.mp4"
